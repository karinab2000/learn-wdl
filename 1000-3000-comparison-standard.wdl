...
task FilterFile {
    ...
    Int disk_size = 1 + 5*ceil(size([input_files, pos_mask_dict, sample_mask_dict], "GB"))
    ...
    command <<<
        ...
        def make_datasets(files, comparison_of_interest):
        ...
        make_datasets(input_files, interest)
